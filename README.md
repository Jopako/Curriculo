...
<img width="1000" height="410" alt="image"  style="border-radius: 500;" src="https://github.com/user-attachments/assets/9ca031dd-d0e9-4f5b-9ee0-26f3610c82ac" />
...
- Comandos interativos no terminal, como:
  - `!comandos`
  - `!github`
  - `!linkedin`
  - `!curriculo`
  - `!clear`
- Página de currículo com informações pessoais, formação, projetos, experiência e habilidades
...
- `src/containers/Entry` — página de entrada
